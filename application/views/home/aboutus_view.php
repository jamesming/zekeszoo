													...
													<div  class=' rounded_bg' >
													  ...
													  <div class="middle">
																...
																<div    id='box_inside'  class="clearfix ">
														  		<div  table='website'    href='#wysiwyg_div' id='aboutus'  class="wysiwyg_div_link_disable clearfix elements_to_hide_when_adding_deal" >
																																<?php     
																																
																																		if( isset( $website[0]->aboutus  ) ){
																																			echo $website[0]->aboutus;
																																		}else{
