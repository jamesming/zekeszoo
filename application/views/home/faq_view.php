													...
													<div  class=' rounded_bg' >
													  ...
													  <div class="middle">
																...
																<div    id='box_inside'  class="clearfix ">
														  		<div  table='website'    href='#wysiwyg_div' id='frequently_asked_questions'  class="wysiwyg_div_link clearfix elements_to_hide_when_adding_deal" >
																																<?php     
																																
																																		if( isset( $website[0]->frequently_asked_questions ) ){
																																			echo $website[0]->frequently_asked_questions;
																																		}else{
