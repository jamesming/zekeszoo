															...
															<div id='buynow_image'>
																...
																<div id='buynow_text' class=' float_left' >
																	...
																	<?php if($howmany_left > 0 ){?>
																			...
																			<span   style='margin-left:34px'  >CLAIM</span>
																			<?php }else{?>
																			BUY NOW
...
//																		echo ( isset( $deals[0]->telephone) &&  $deals[0]->telephone!= '' ? $deals[0]->telephone."<br />":'' );
																		echo "<p><br /><a target='_blank' href='http://" . ( isset( $deals[0]->vendor_website) ? $deals[0]->vendor_website:'' ) .  "'>http://" . ( isset( $deals[0]->vendor_website) ? $deals[0]->vendor_website:'' ) ."</a></p>";
																		?>			
