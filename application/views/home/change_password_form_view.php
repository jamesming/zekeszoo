													...
													<div  class=' rounded_bg' >
													  ...
													  <div class="middle left_middle"   style='min-height:302px'  >
																...
																<div    id='box_inside'  class="clearfix "   >
																	...
																	<div class=' input_div' >
																		<input name="password" id="password" type="text" value=""  class='small_input '>
																	</div>
...
$(document).ready(function() {
				...
				$('.middle.left_middle #password').click(function(event) {
					$(this).val('');
					$('.error_message').hide();
				});	
				...
				$('#update_image').click(function(event) {
						$.post("<?php echo base_url(). 'index.php/home/update_a_new_password/' ?>",{
