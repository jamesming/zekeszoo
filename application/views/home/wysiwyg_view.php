...
the following script tag replaces this remarked one -->
...
<script language="Javascript" type="text/javascript">
			...
			$(document).ready(function() { 
				...
				var project_number = window.parent.$('#project_number').val();
				var table = window.parent.$('#table').val();
				...
				$('#save').click(function(event) {
						...
						$.post("<?php echo base_url(). 'index.php/home/update_method/' . $deal_id; ?>",{
							field: div_id_to_edit,
							text: mbox.get_html(),
							table: table
							},function(data) {

								window.parent.$('#'+div_id_to_edit).html(  mbox.get_html()  ).css({background:'clear'});
