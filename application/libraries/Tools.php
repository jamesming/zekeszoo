 ...
 * {@source }
 * @package BackEnd
 * @param string $original_image, $bw_image
 */
 
	
function make_black_and_white($original_image, $bw_image){
	
	$im = imagecreatefrompng($original_image);
	imagefilter($im, IMG_FILTER_GRAYSCALE);
	imagefilter($im, IMG_FILTER_CONTRAST, -100);
	
	imagepng($im, $bw_image);
...
/**
 * convert_to_PNG_image_from_file
 *
 * {@source }
 * @package BackEnd
 * @return string
 */
	...
	function convert_to_PNG_image_from_file($filename, $new_width, $location) {  
