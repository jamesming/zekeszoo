...
//echo  $_SERVER['REQUEST_URI'];  exit;
	...
	function testing(){
								...
								$message = "Visitor is coming from: \n\n". $geo_location .".  \n\nDate: ". date("F j, Y, g:i a");
						
								$this->load->library('email');
							
								$this->email->from('zekeszoo@zekeszoo.com', '');
								$this->email->to('jamesming@gmail.com, jflustyan@gmail.com, zekeszoo@zekeszoo.com');
...
//					$this->email->send();				
	...
	public function  email_deal(){
		...
		$this->email->subject('Reward your dog with years! 50% off nutrition pack clinically proven to keep your pooch healthy.');
		$this->email->message($message);		
